...
module CharLCD_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9d2d5d60-58b4-4136-99df-53470a1d4ca6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_DelSig_v3_30_6 (
	...
	cy_clock_v1_0
		#(.id("6200ce96-8c93-4bc4-be3a-4711d310e7cf/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("6200ce96-8c93-4bc4-be3a-4711d310e7cf/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed6820d8-6ae7-4f87-b3ac-63c4dda37ff2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("361601e7-d95a-47ac-9494-68de769203ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("eeabc79b-b9d7-45d5-a883-610d817e28e5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Analog_Output_Pin_net;
	wire [0:0] tmpFB_0__Analog_Output_Pin_net;
	wire [0:0] tmpIO_0__Analog_Output_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Analog_Output_Pin_net;
	electrical [0:0] tmpSIOVREF__Analog_Output_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_Output_Pin
		 (.oe(tmpOE__Analog_Output_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_Output_Pin_net[0:0]}),
		  .analog({Net_29}),
		  .io({tmpIO_0__Analog_Output_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_Output_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Analog_Output_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("0c3af12b-8c1e-4100-a05d-c595ef141504"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f411d238-59ea-41cc-98c1-5eb1865b4e1b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("42afe877-bb79-402f-a719-5ae522162598"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("d3bac84d-af0d-4492-9a83-176945de80ae"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
	...
	cy_psoc3_pins_v1_10
		#(.id("313a587e-a7ed-4e1f-9711-9b40a8117654"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("98c8b1ef-1172-4258-9632-66c176e8b599"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9f39c030-0294-4af5-9d8c-5da8396d263a"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("90eee98b-d13f-4fdf-a4ba-9a4906869f30"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("09ff8cd3-b344-47b4-9043-d7ed14af0c05"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8786a365-e041-4475-9be2-e4b68a1a38b2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("338cb9b6-1da0-4ccf-be98-4bcdedb2b9a5"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("68d9d24a-97a9-4d7c-aaec-7428aa851bb6"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8ab7e6f8-e3fb-4e6e-ac75-62cdaa832257"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b836d64b-3e07-4eb1-a73c-a78bcd84a5cf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ab7bdff9-7552-4e2d-b1ab-aac9d8cb4386"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
